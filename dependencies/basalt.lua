---@diagnostic disable: param-type-mismatch, lowercase-global, lowercase-global, cast-local-type, need-check-nil, redundant-parameter, redundant-parameter, undefined-global, duplicate-index, ambiguity-1
